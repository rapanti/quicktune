...
from quicktune.data.metaloader import MetaLoader
...
def meta_train_surrogate(
    ...
    """
    assert metric in ["perf", "cost"], f"Unknown metric {metric}."
    ...
    loader = MetaLoader(metaset, batch_size, seed)
